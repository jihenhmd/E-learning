...
$(function() {
   ...
   $("#add-questionsTF").on('click', function(e){
     e.preventDefault();
     addQuestionnsTF()
   });

  $("#questionsTF").on('click', '.removeItemElement', function(e){
    var item = this; 
