...
$(function() {
   ...
   $("#add-questionsTF3").on('click', function(e){
     e.preventDefault();
     addQuestionnsTF3()
   });

  $("#questionsTF3").on('click', '.removeItemElement', function(e){
    var item = this; 
