...
$(function() {
   ...
   $("#add-questionsHomeworkMc").on('click', function(e){
     e.preventDefault();
     addQuestionnsHomeworkMc()
   });

  $("#questionsHomeworkMc").on('click', '.removeItemElement', function(e){
    var item = this; 
