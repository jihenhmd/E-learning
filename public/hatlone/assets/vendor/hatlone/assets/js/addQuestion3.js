...
$(function() {
   ...
   $("#add-questions3").on('click', function(e){
     e.preventDefault();
     addQuestionns3()
   });

  $("#questions3").on('click', '.removeItemElement', function(e){
    var item = this; 
