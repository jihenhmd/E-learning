...
$(function() {
   ...
   $("#add-questionsMchoice3").on('click', function(e){
     e.preventDefault();
     addQuestionnsMchoice3()
   });

  $("#questionsMchoice3").on('click', '.removeItemElement', function(e){
    var item = this; 
