...
$(function() {
   ...
   $("#add-qa2").on('click', function(e){
     e.preventDefault();
     addQa()
   });

  $("#questionsQa2").on('click', '.removeItemElement', function(e){
    var item = this; 
