...
$(function() {
   ...
   $("#add-questions-exam3").on('click', function(e){
     e.preventDefault();
     addQuestionnsExam3()
   });

  $("#questionsExam3").on('click', '.removeItemElement', function(e){
    var item = this; 
