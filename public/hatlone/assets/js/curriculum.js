var rowSize = 30; // => container height / number of items
var container = document.querySelector(".itemOrder");
...
function Sortable(element, index) {
  var content = element.querySelector(".itemContent");
  var order = element.querySelector(".steps");
