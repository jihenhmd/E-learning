...
$(function() {
   ...
   $("#add-questionsMchoice2").on('click', function(e){
     e.preventDefault();
     addQuestionnsMchoice2()
   });

  $("#questionsMchoice2").on('click', '.removeItemElement', function(e){
    var item = this; 
