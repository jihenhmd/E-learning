...
$(function() {
   ...
   $("#add-questions2").on('click', function(e){
     e.preventDefault();
     addQuestionns2()
   });

  $("#questions2").on('click', '.removeItemElement', function(e){
    var item = this; 
