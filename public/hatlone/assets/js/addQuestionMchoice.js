...
$(function() {
   ...
   $("#add-questionsMchoice").on('click', function(e){
     e.preventDefault();
     addQuestionnsMchoice()
   });

  $("#questionsMchoice").on('click', '.removeItemElement', function(e){
    var item = this; 
